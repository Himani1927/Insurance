...
import { TextField, Button, CardContent, Card, Grid, Typography } from '@mui/material'


export default function BasicDetails({ insuranceData, setInsuranceData, handleNext }) {
